            ...
            if mes_con:
                ...
                if os.path.exists(ruta_a_consultar):
                    try:
                        ...
                        if empresa_sel_con:
                            # LECTURA DIRECTA LIMPIA: Toma exactamente la Fila 0 como cabecera (header=0) sin buscar filas adicionales
                            df_vista = pd.read_excel(ruta_a_consultar, sheet_name=empresa_sel_con, header=0)
