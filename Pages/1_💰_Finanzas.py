...
st.sidebar.title("Finanzas Grupo SERVYRE")
st.sidebar.markdown("---")
menu_fin = st.sidebar.radio("Seleccione módulo:", ["Panel", "Facturación", "OC y SP", "Reporte Pagos"], key="menu_fin_sub")
...
if menu_fin == "Panel":
    st.title("Grupo SERVYRE — Panel Financiero")
